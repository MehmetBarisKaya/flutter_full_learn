...
import 'package:flutter101/202/cache/user_cache/user_cache_manager.dart';
import 'package:flutter101/202/cache/user_model.dart';
...
class _SharedListCacheState extends LoadingStatefull<SharedListCache> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: isLoading ? const CircularProgressIndicator(color: Colors.red) : null,
        actions: isLoading
            ? null
            : [
                IconButton(
